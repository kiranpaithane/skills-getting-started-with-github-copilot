...
activities = {
    ...
    "Science Olympiad": {
        "description": "Explore science challenges with hands-on experiments and competitions",
        "schedule": "Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "maya@mergington.edu"]
    },
    "Debate Team": {
        "description": "Build public speaking and critical thinking skills through formal debates",
    ...
    "Swimming Club": {
        "description": "Practice swimming skills and build endurance in the pool",
